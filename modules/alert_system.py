...
def generate_pdf_report(assessment_data):
    try:
        ...
        title_s   = S("T",  fontSize=18, alignment=TA_CENTER,
                      fontName="Helvetica-Bold", spaceAfter=4,
                      textColor=colors.HexColor("#1a1a2e"))
        sub_s     = S("Su", fontSize=9, alignment=TA_CENTER,
                      textColor=colors.grey, spaceAfter=8)
        heading_s = S("H",  fontSize=12, fontName="Helvetica-Bold",
                      spaceBefore=12, spaceAfter=4,
                      textColor=colors.HexColor("#1a1a2e"))
        body_s    = S("B",  fontSize=9, leading=14, spaceAfter=4,
                      textColor=colors.HexColor("#333333"))
        note_s    = S("N",  fontSize=8, leading=12, spaceAfter=4,
        ...
        story += [
            ...
            Paragraph(
                "Dark Web Intel Tool | BCA Final Year Project | "
                "OSINT Academic Implementation | SDG 16", sub_s),
        ...
        story.append(Paragraph(
            "DISCLAIMER: Generated by Dark Web Threat Intelligence Tool - "
            "BCA Final Year Academic Project, Sushant University. "
            "All data is OSINT-based or simulated for educational purposes. "
            "No illegal systems were accessed. Aligns with SDG Goal 16.",
            note_s
        ))
